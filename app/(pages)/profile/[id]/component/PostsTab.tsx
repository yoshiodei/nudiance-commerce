  ...
  return (
    <div className="w-full rounded bg-white p-[20px] border border-slate-300 ">
            <div className="flex justify-between items-center">
                ...
                <button onClick={() => router.push('/sellnow/select-category')} className="flex items-center gap-2 bg-primary text-white rounded h-[2.2em] px-2 cursor-pointer">
                  <IoMdAdd />  
            ...
            <div className="p-5 flex justify-center">
                <div className="flex items-center flex-col gap-5">
                  ...
                  <button onClick={() => router.push('/sellnow/select-category')} className="cursor-pointer flex items-center gap-2 bg-primary text-white rounded h-[2.2em] px-2">
                    <IoMdAdd />  
                    <h6>Add Post</h6>
                  </button>
                </div>
