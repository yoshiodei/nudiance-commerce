...
export default function CategoriesProductsSection() {
    ...
    <div className="w-full flex justify-center mt-5">
      <div className="h-full xl:w-[1400px] sm:px-[50px] px-[5vw] w-full">
        <div className="flex justify-between items-center">
          <h1 className="font-bold sm:text-[1.2em] text-[1em] sm:py-5 py-[20px]">Explore Products Under Category &ldquo;Electronics&rdquo;</h1>
          <Drawer>
